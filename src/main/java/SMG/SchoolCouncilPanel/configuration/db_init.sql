...
('Loops workshop', '3', 'https://www.youtube.com/embed/WhCTwXYOF3M', 'Author: Dobrin Bashev', 'http://SchoolCouncilPanel.SMG.bg/contests/ProgrammingBasics5') ,
('Loops workshop', '3', '#', 'Author: Dobrin Bashev', 'http://SchoolCouncilPanel.SMG.bg/contests/ProgrammingBasics5') ;--,
